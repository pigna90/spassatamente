...
export const PodcastEpisodes: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Version */}
      <section className="mobile-episodes-section">
        <div className="episodes-section">
          {/* Last Episode for Mobile */}
          <div className="mobile-last-episode-container">
            <MobileEpisodeCard
              episode={featuredEpisode}
              onPlay={() => handlePlay(featuredEpisode)}
              isLast={true}
            />
          </div>

          {/* Other Episodes for Mobile */}
          <div className="mobile-episodes-grid">
            {recentEpisodes.map((episode) => (
              <MobileEpisodeCard
          ...
          {hasMoreEpisodes && (
            <div style={{ margin: '6vw', marginTop: '8vw' }}>
              <button 
                onClick={handleViewAllEpisodes}
                className="show-more-button"
              >
                Vedi Tutti su Spotify
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7 17L17 7M17 7H7M17 7V17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
